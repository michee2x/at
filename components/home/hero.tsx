...
const Hero = () => {
  return (
    <section
      ...
      className="max-w-screen w-full h-[720px] bg-gradient-to-b from-transparent via-gray-100 to-gray-300 px-4 relative overflow-hidden sm:h-[calc(1300/1600*100vw)] pt-[72px] lg:pt-[95px] flex flex-col items-center md:h-[calc(1300/1600*100vw)] lg:h-[calc(1180/1600*100vw)] xl:h-[calc(1100/1600*100vw)] 2xl:h-[calc(1000/1600*100vw)]"
    >
      <div className="left-0 max-w-screen top-0 flex items-center flex-col h-[235px] gap-[14px] lg:gap-[24px]">
        <div className="flex flex-col justify-center items-center gap-[4px]  min-h-[137px] ">
          ...
          <h1 className="max-w-[711px] lg:mt-3 text-center max-h-[54px]">
            <span className="hidden lg:max-w-2xl sm:flex text-[12px] lg:text-[15px] font-poppins font-normal leading-[150%] text-center sm:max-w-xl align-middle -tracking-[0.5%]">
              Explore a curated marketplace of African brands, artisans, and
              entrepreneurs — <br /> shop and support Africa’s creativity with every
              purchase.
            </span>
