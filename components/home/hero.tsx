...
const Hero = () => {
  return (
    <section
      ...
      className="max-w-screen w-full h-[720px] bg-gradient-to-b from-transparent via-gray-100 to-gray-300 px-4 relative overflow-hidden sm:h-[calc(1300/1600*100vw)] pt-[95px] flex flex-col items-center md:h-[calc(1300/1600*100vw)] lg:h-[calc(1180/1600*100vw)] xl:h-[calc(1100/1600*100vw)] 2xl:h-[calc(1000/1600*100vw)]"
    >
