    ...
    <footer className="w-full hidden lg:flex items-center justify-center  bg-white border-t border-gray-200 py-12">
      <div className="w-fit h-auto mx-auto px-6 flex flex-col items-center gap-12">
        ...
        <div className="flex items-center justify-center gap-4">
          {[
            { src: "/home/vector icons/vec 1.png", name: "Playstore" },
            { src: "/home/vector%20icons/vec%202.png", name: "Appstore" },
          ].map((button, idx) => {
            return (
              <div
                key={`${button.src}`}
                className="flex rounded-[40px] w-[158px] h-[56px] px-[12px] py-[24px]  bg-[#000000] gap-[15px] items-center justify-center"
              >
                <Image
                  src={button.src}
                  alt="vector icon"
                ...
                <div className="flex h-fit flex-col">
                  <span className="text-[9.8px] text-nowrap font-semibold text-[#FFFFFF]">
                    Download on
                  </span>
                  <span className="text-[15.67px] font-semibold text-[#FFFFFF]">
                    {button.name}
                  </span>
                </div>
              </div>
