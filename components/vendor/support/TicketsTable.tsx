    ...
    return (
      <div className="flex flex-col items-center justify-center py-16 text-center bg-white rounded-lg border">
        <div className="bg-gray-50 p-4 rounded-full mb-4">
          <svg className="h-8 w-8 text-gray-400" viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M3 7v10a2 2 0 0 0 2 2h14" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/></svg>
        </div>
    ...
    <div className="bg-white rounded-lg border overflow-hidden">
      <Table>
        ...
        <TableBody>
          {tickets.map((t) => (
            <TableRow key={t.id}>
              <TableCell className="font-medium">#{t.ticket_id ?? t.id}</TableCell>
              <TableCell>
