...
export default function CategoryPage() {
  ...
  return (
    <div className="h-auto w-full md:max-w-[95%] lg:max-w-full xl:max-w-[1300px] 2xl:max-w-[1440px] font-poppins bg-white">
      {/* Banner */}
      <div className="w-full relative h-[245px] bg-blue-600">
        ...
        <Image
          ...
          fill
        />
        <div className="w-[328px] left-[15%] items-end bottom-[5%] flex justify-center items-center h-[46px] absolute">
...
function ProductCard({ product }: { product: any }) {
  return (
    <div className="border border-gray-200 font-poppins bg-white rounded-xl p-3 flex flex-col">
      ...
      <div className="flex mt-3 lg:mt-6 flex-col lg:flex-row justify-between lg:items-center">
        ...
        <button className="lg:mt-auto mt-2 w-full lg:w-[110px] text-[10px] bg-[#6A00EF] text-white py-[8px] rounded-[24px] hover:bg-purple-700 items-center gap-1 justify-center flex transition">
